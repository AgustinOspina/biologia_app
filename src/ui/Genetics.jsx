        ...
        try {
            ...
            const requestBody = {
                ...
                messages: [
                    {
                        "role": "system",
                        "content": "Eres un asistente que responde preguntas en español y adaptadas para niños de entre 10 y 18 años. Si la pregunta o frase dada no esta relacionada al tema de la genética, responde 'Tema invalido'."
                    },
                    {   role: 'user', 
                        content: question,
                    },
        ...
        <div>
            <Form>
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label><h2>Genética</h2></Form.Label>
                    <Form.Control 
                        type="question" 
                    ...
                    <Form.Text className="text-muted">
                        Realiza preguntas unicamente sobre genética.
                    </Form.Text>
                </Form.Group>
